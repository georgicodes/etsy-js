(function() {
  ...
  User = (function() {
    ...
    User.prototype.addresses = function(_arg, cb) {
      ...
      return (_ref = this.client).get.apply(_ref, ["/users/" + this.userId + "/addresses", token, secret].concat(__slice.call(params), [function(err, status, body, headers) {
        if (err) {
          return cb(err);
        }
        if (status !== 200) {
